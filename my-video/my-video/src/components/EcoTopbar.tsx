...
export const EcoTopbar: React.FC<Props> = ({ monthLabel, dark }) => {
  return (
    <div style={{
      ...
      <div>
        ...
        <h1 style={{ margin: "4px 0 0", fontSize: 22, fontWeight: 700, color: dark ? "#F3F4F8" : "#1A1D2B" }}>Dashboard</h1>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <span style={{ fontSize: 12, color: "#6B7280", fontWeight: 600 }}>{monthLabel}</span>
        <div style={{ width: 34, height: 34, borderRadius: 8, background: dark ? "#2D3142" : "#F0F1F5", display: "grid", placeItems: "center", fontSize: 12 }}>{dark ? "🌙" : "☀"}</div>
