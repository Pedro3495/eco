...
export const EcoSidebar: React.FC<Props> = ({ dark }) => {
  return (
    <div style={{
      width: 220, height: "100%", padding: "28px 18px", display: "flex", flexDirection: "column",
      borderRight: `1px solid ${dark ? "#2D3142" : "#E5E7EB"}`,
      background: dark ? "rgba(26,29,43,0.72)" : "rgba(255,255,255,0.72)",
      backdropFilter: "blur(18px)"
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "4px 10px 24px", fontSize: 22, fontWeight: 800, color: dark ? "#4DDD93" : "#08683C" }}>
      ...
      <nav style={{ display: "grid", gap: 8 }}>
        {items.map((item, i) => (
          <div key={item} style={{
            ...
            color: i === 0 ? "#fff" : (dark ? "#6B7280" : "#6B7280"),
